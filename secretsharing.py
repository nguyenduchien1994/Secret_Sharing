...
def amdEncoder(S,f):
    ...
    int_E3 = F.Add(F.Multiply(int_S0,R),F.Add(F.Multiply(F.Multiply(R,R),int_S1),F.Multiply(F.Multiply(F.Multiply(R,R),R),int_S2)))
    bin_E3 = '{0:08b}'.format(int_E3)
...
def amdDecoder(E,f):
    ...
    eval_E3 = F.Add(F.Multiply(int_S0,R),F.Add(F.Multiply(F.Multiply(R,R),int_S1),F.Multiply(F.Multiply(F.Multiply(R,R),R),int_S2)))
